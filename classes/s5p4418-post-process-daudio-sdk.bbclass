...
postprocess_install_daudio_sdk_function() {
	install -m 0644 ${PWD}/../meta-nexell/recipes-sdk/qt/nexell-daudio-sdk/files${systemd_system_unitdir}/android-tools-adbd.service ${IMAGE_ROOTFS}${systemd_system_unitdir}/
}
