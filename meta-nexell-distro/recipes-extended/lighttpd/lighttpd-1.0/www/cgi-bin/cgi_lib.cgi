...
show_msg ()
{
    ...
    echo '<img src="/images/Nexell-logo-White_Transpraency_50-1.png" width="178" height="18" alt="" title="" border="0" />'
    echo '</div>'
    echo '<div class="clear"></div>'
    echo '</div>'
    echo '<div>&nbsp;</div>'
	...
	echo '<font style="color:#fff;">Copyright &copy; 2009-2018, Nexell Technologies</font>'
	echo '</div>'
    echo '</body>'
    echo '</html>'
}
