...
TS_POINTERCAL = "${@bb.utils.contains('DISTRO_FEATURES', 'nexell-daudio-ref', 'pointercal-daudio_ref', \
                bb.utils.contains('DISTRO_FEATURES', 'nexell-nxp3220-evb', 'pointercal-navi_ref', \
                bb.utils.contains('DISTRO_FEATURES', 'nexell-navi-ref', 'pointercal-nxp3220_evb', 'not_supported', d), d), d)}"
