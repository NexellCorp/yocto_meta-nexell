...
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x16\x03\x66\xcb\x34\x00\x66\xcb\x34\x7f\x00\x00"
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x16\x04\x66\xcb\x34\x80\x66\xcb\x34\xff\x00\x00"
...
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x12\x03\x00\x00\x00\x11\x00\x00"
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x12\x04\x00\x00\x00\x11\x00\x00"
...
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x0B\x03\x00\x00\x00\x00\x00\x00"
echo ""
spidevtest -OH -D /dev/spidev0.0 -v -p "\x0B\x04\x00\x00\x00\x00\x00\x00"
sleep 1
