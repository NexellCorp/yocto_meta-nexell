...
SRC_URI = "https://review.gerrithub.io/NexellCorp/linux_library_gst-plugins-video-enc;protocol=https;branch=nexell"
...
EXTRA_OEMAKE = " \
 ...
 'libgstnxvideoenc_la_LDFLAGS = $(GST_PLUGIN_LDFLAGS) -L${STAGING_LIBDIR} -ldrm' \
"
