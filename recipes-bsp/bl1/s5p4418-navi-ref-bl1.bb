...
SRC_URI = "git://git.nexell.co.kr/nexell/bl1/bl1-s5p4418;protocol=git;branch=artik \
           file://0001-Yocto-bl1-NAVI-4418-Board-setting.patch \
          "
...
do_compile () {
    oe_runmake CROSS_TOOL_TOP=${TOOLCHAIN_ARCH32_EABI} BOARD="NAVI" -j 1
}

do_install_append() {
    echo "${WORKDIR}/git/out/bl1-navi.bin" >> ${BASE_WORKDIR}/image_where.txt
}
