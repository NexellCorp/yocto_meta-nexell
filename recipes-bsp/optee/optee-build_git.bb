...
COMMON_FLAGS = "PLAT_DRAM_SIZE=1024 PLAT_UART_BASE=0xc00a3000 ${SECURE-OPTEE} CROSS_COMPILE=${TARGET_PREFIX} CROSS_COMPILE32=${TOOLCHAIN_32} YOCTO_DTB=${OPTEE_BUILD_TARGET_MACHINE}.dtb YOCTO_DEFCONFIG=${OPTEE_KERNEL_DEFCONFIG-${OPTEE_BUILD_TARGET_MACHINE}} UBOOT_DIR=${S}/u-boot-artik7"
