...
do_compile() {
    cd ${S}/src/ES1_tutorial1
    oe_runmake CROSSNAME=${TARGET_PREFIX} INCLUDE="-I${S}/src/3rdparty/include/khronos -I${STAGING_INCDIR} -I${S}/src/ES1_tutorial1"

    cd ${S}/src/ES2_tutorial1
    oe_runmake CROSSNAME=${TARGET_PREFIX} INCLUDE="-I${S}/src/3rdparty/include/khronos -I${STAGING_INCDIR} -I${S}/src/ES2_tutorial1"
}
...
do_install () {
    ...
    install -m 0755 ${S}/src/ES1_tutorial1/tutorial1_es1 ${D}${bindir}/sdl_example/
    install -m 0755 ${S}/src/ES2_tutorial1/tutorial1_es2 ${D}${bindir}/sdl_example/
    install -m 0644 ${S}/src/ES2_tutorial1/t1_rend.frag  ${D}${bindir}/sdl_example/
    install -m 0644 ${S}/src/ES2_tutorial1/t1_rend.vert  ${D}${bindir}/sdl_example/
