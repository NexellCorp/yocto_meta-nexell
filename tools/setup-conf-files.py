...
#Use QT recipes
CONF_APPEND_USE_QT = ['PACKAGECONFIG_FB_pn-qtbase = "linuxfb"',
                      'PACKAGECONFIG_DISTRO_pn-qtbase = "accessibility alsa tslib gles2 glib examples tools openssl"',
                      'PACKAGECONFIG_append_pn-qtmultimedia  = " gstreamer"',
                      'LICENSE_FLAGS_WHITELIST = "commercial"']
#Use weston & wayland recipes
CONF_APPEND_USE_WSWL = ['DISTRO_FEATURES_append = " systemd wayland opengl"',
