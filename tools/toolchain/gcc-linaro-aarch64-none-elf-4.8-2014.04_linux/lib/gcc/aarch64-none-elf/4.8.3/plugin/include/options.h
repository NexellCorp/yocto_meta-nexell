...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1041,                       /* -mcmodel= */
  OPT_mcpu_ = 1042,                          /* -mcpu= */
  OPT_mgeneral_regs_only = 1043,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1044,                 /* -mlittle-endian */
  OPT_momit_leaf_frame_pointer = 1045,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1046,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1047,                  /* -mtls-dialect= */
  OPT_mtune_ = 1048,                         /* -mtune= */
  OPT_n = 1049,                              /* -n */
  OPT_no_canonical_prefixes = 1050,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1051,              /* -no-integrated-cpp */
  OPT_nocpp = 1052,                          /* -nocpp */
  OPT_nodefaultlibs = 1053,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1054,                   /* -nostartfiles */
  OPT_nostdinc = 1055,                       /* -nostdinc */
  OPT_nostdinc__ = 1056,                     /* -nostdinc++ */
  OPT_nostdlib = 1057,                       /* -nostdlib */
  OPT_o = 1058,                              /* -o */
  OPT_p = 1059,                              /* -p */
  OPT_pass_exit_codes = 1060,                /* -pass-exit-codes */
  /* OPT_pedantic = 1061, */                 /* -pedantic */
  OPT_pedantic_errors = 1062,                /* -pedantic-errors */
  OPT_pg = 1063,                             /* -pg */
  OPT_pie = 1064,                            /* -pie */
  OPT_pipe = 1065,                           /* -pipe */
  OPT_print_file_name_ = 1066,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1067,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1068,          /* -print-multi-directory */
  OPT_print_multi_lib = 1069,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1070,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1071,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1072,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1073,               /* -print-prog-name= */
  OPT_print_search_dirs = 1074,              /* -print-search-dirs */
  OPT_print_sysroot = 1075,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1076,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1077,                          /* -quiet */
  OPT_r = 1078,                              /* -r */
  OPT_remap = 1079,                          /* -remap */
  OPT_s = 1080,                              /* -s */
  OPT_s_bc_abi = 1081,                       /* -s-bc-abi */
  OPT_save_temps = 1082,                     /* -save-temps */
  OPT_save_temps_ = 1083,                    /* -save-temps= */
  OPT_shared = 1084,                         /* -shared */
  OPT_shared_libgcc = 1085,                  /* -shared-libgcc */
  /* OPT_specs = 1086, */                    /* -specs */
  OPT_specs_ = 1087,                         /* -specs= */
  OPT_static = 1088,                         /* -static */
  OPT_static_libasan = 1089,                 /* -static-libasan */
  ...
  OPT_static_libtsan = 1095,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1096, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1097, */                /* -std=c++0x */
  OPT_std_c__11 = 1098,                      /* -std=c++11 */
  OPT_std_c__1y = 1099,                      /* -std=c++1y */
  OPT_std_c__98 = 1100,                      /* -std=c++98 */
  OPT_std_c11 = 1101,                        /* -std=c11 */
  /* OPT_std_c1x = 1102, */                  /* -std=c1x */
  /* OPT_std_c89 = 1103, */                  /* -std=c89 */
  OPT_std_c90 = 1104,                        /* -std=c90 */
  OPT_std_c99 = 1105,                        /* -std=c99 */
  /* OPT_std_c9x = 1106, */                  /* -std=c9x */
  OPT_std_f2003 = 1107,                      /* -std=f2003 */
  OPT_std_f2008 = 1108,                      /* -std=f2008 */
  OPT_std_f2008ts = 1109,                    /* -std=f2008ts */
  OPT_std_f95 = 1110,                        /* -std=f95 */
  OPT_std_gnu = 1111,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1112, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1113, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1114,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1115,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1116,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1117,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1118, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1119, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1120,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1121,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1122, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1123, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1124,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1125, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1126, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1127, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1128,                     /* -std=legacy */
  OPT_symbolic = 1129,                       /* -symbolic */
  OPT_t = 1130,                              /* -t */
  OPT_time = 1131,                           /* -time */
  OPT_time_ = 1132,                          /* -time= */
  OPT_traditional = 1133,                    /* -traditional */
  OPT_traditional_cpp = 1134,                /* -traditional-cpp */
  OPT_trigraphs = 1135,                      /* -trigraphs */
  OPT_u = 1136,                              /* -u */
  OPT_undef = 1137,                          /* -undef */
  OPT_v = 1138,                              /* -v */
  OPT_version = 1139,                        /* -version */
  OPT_w = 1140,                              /* -w */
  OPT_wrapper = 1141,                        /* -wrapper */
  OPT_x = 1142,                              /* -x */
  OPT_z = 1143,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
